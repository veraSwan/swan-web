      ...
      <div className="layout-container">
        <div className="grid grid-cols-1 md:grid-cols-4 grid-spacing mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/" className="text-[#E5E7EB]/70 hover:text-[#C05775] hover:translate-x-1 text-sm transition-all w-fit">Start</Link>
            <Link to="/about" className="text-[#E5E7EB]/70 hover:text-[#C05775] hover:translate-x-1 text-sm transition-all w-fit">O nas</Link>
            <Link to="/services" className="text-[#E5E7EB]/70 hover:text-[#C05775] hover:translate-x-1 text-sm transition-all w-fit">Usługi</Link>
            <Link to="/portfolio" className="text-[#E5E7EB]/70 hover:text-[#C05775] hover:translate-x-1 text-sm transition-all w-fit">Portfolio</Link>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/contact" className="text-[#E5E7EB]/70 hover:text-[#C05775] hover:translate-x-1 text-sm transition-all w-fit">
              Napisz do nas
            </Link>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-[#5A4B81]/20 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link to="#" className="text-[#E5E7EB]/50 hover:text-white text-xs transition-colors">Polityka Prywatności</Link>
            <Link to="#" className="text-[#E5E7EB]/50 hover:text-white text-xs transition-colors">Regulamin</Link>
          </div>
        </div>
      </div>
    </footer>
