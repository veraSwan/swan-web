...
const AurelineDistrictPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Aureline District - Luxury Real Estate Case Study</title>
        <meta name="description" content="Luksusowa strona dewelopera premium. Nieskazitelny design." />
      </Helmet>
        ...
        <article className="layout-container relative z-10 max-w-5xl mx-auto">
          ...
          >
            <motion.div variants={variants.fadeInUp} className="w-full mb-6">
              <span className="text-[#A1A1AA] uppercase tracking-[0.3em] text-xs font-medium">Nieruchomości / Premium</span>
            </motion.div>
            <motion.h1 
            ...
            <motion.p variants={variants.fadeInUp} className="text-lg md:text-xl text-white/70 font-light leading-[1.8] tracking-wide max-w-2xl">
              Adres zjawiskowy, przełożony na równie imponujące środowisko wirtualne.
            </motion.p>
          </motion.header>
          ...
          >
            <div className="relative w-full bg-[#1A1C20] rounded-t-[1.5rem] p-3 pb-0 shadow-2xl border border-white/5 border-b-0 hover-lift">
              <div className="aspect-[16/10] bg-[#121212] rounded-t-xl overflow-hidden relative">
                <img 
                  src="https://images.unsplash.com/photo-1679679816813-c8431492ad57" 
                  alt="Aureline District Hero" 
          ...
          >
            <motion.h2 variants={variants.fadeInUp} className="text-3xl md:text-5xl font-light mb-8 tracking-tight" style={{ fontFamily: 'Playfair Display, serif' }}>Architektura tożsamości</motion.h2>
            <motion.p variants={variants.fadeInUp} className="text-base md:text-lg font-light leading-[1.8] text-white/70 tracking-wide">
              Strona wizualizuje bryłę oraz jakość deweloperską. Powściągliwy układ modułów wzmacnia doznania płynące z majestatycznych ujęć architektury.
            </motion.p>
          </motion.div>
          ...
          >
            {["https://images.unsplash.com/photo-1691566766396-a353cd124a27", "https://horizons-cdn.hostinger.com/cfa5146f-52ac-42eb-a177-ef9cb7c13f59/da2625a52ca40a15ced940f2f5b3e7ab.png"].map((imgSrc, idx) => (
...
export default AurelineDistrictPage;