...
const LINIAStudioPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>LINIA Studio Wnętrz - Portfolio</title>
        <meta name="description" content="Projektowanie wnętrz. Nowoczesne studio opierające się na harmonii." />
      </Helmet>
...
export default LINIAStudioPage;